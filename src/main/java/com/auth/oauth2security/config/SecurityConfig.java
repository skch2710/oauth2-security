package com.auth.oauth2security.config;
...
//		var user1 = User.withUsername("skch2710@gmail.com").password(passwordEncoder().encode("S@thi$+b27")).roles("USER").build();
//		var user2 = User.withUsername("skch@gmail.com").password(passwordEncoder().encode("password")).roles("USER", "ADMIN").build();
